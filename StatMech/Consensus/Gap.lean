...
theorem partitionFunctionOn_eq_restricted {Exec : Type} [Fintype Exec] [DecidableEq Exec]
    ...
    StatMech.Consensus.partitionFunctionOn H β A = restrictedPartitionFunction H β A := by
  rfl
