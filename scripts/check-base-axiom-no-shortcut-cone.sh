...
if rg -n --glob 'BaseAxiom*.lean' '^import Gibbs\.ContinuumField\.NavierStokes\.(Global\.ClayEndgame|HardStep\.Definitive\.TrueTorusClayBUnconditional|HardStep\.Definitive\.TrueTorusFluxBarrier)' "$TARGET_DIR" >/dev/null; then
