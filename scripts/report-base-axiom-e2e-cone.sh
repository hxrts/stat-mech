...
FILES=(
  ...
  "$ROOT/StatMech/ContinuumField/NavierStokes/Faithful/BaseAxiomClassicalSemantics.lean"
)

{
  ...
  echo ""
  echo "## Required Gates"
  echo "- lake build StatMech.ContinuumField.NavierStokes.Faithful.BaseAxiomCompletion"
